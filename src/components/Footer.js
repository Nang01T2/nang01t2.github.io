    ...
    return (
      <footer className="flex h-10 justify-center items-center shadow-inner">
        {this.props.icon_name == "github" ? (
          ...
          <SiQuora
            style={{
              color: this.state.quora_current_color,
              fontSize: this.icon_font_size,
            }}
            onMouseEnter={() => {
              this.setState(() => ({ quora_current_color: this.quora_color }));
            }}
            onMouseLeave={() => {
              this.setState(() => ({ quora_current_color: this.normal_color }));
            }}
          />
        ) : null}
      </footer>
      ...
      <div className="footer-container-links">
        <div className="footer-links">
          ...
          {props.quora == true ? (
            <div className="link-item">
              <a
                href="https://www.quora.com/profile/Lakshmi-Narayana-217"
                className="link"
                rel="noreferrer"
                target="_blank"
              >
